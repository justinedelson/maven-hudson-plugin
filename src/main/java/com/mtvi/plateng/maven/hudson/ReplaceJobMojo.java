...
public class ReplaceJobMojo extends AddJobMojo {
     ...
     * @see com.mtvi.plateng.maven.hudson.AddJobMojo#execute()
     */
    @Override
     ...
     * @see com.mtvi.plateng.maven.hudson.AddJobMojo#createPostURL()
     */
    @Override
     ...
     * 
     * @return false
     * @see com.mtvi.plateng.maven.hudson.AddJobMojo#jobExists()
     */
    @Override
